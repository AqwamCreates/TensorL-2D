...
These terms and conditions (“Agreement”) is a legal agreement between you (or company or organization) recognized as “User” and Aqwam Harish Aiman recognised as “Licensor” for the use of TensorL-2D Library (“Library”) within these terms and conditions. By using the Library, User agrees to be bound by the terms and conditions of this Agreement.
...
* If the User remove the attributions without the Licensor’s permission, User must pay monetary compensation to the Licensor based on a percentage of commercial value generated by them and losses to Licensor as a result from not displaying the attributions. No other forms of compensation will be accepted.
