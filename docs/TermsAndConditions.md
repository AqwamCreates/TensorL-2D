...
These terms and conditions (“Agreement”) is a legal agreement between you (or company or organization) recognized as “User” and Aqwam Harish Aiman recognised as “Licensor” for the use of TensorL-2D Library (“Library”) within this terms and conditions. By using the Library, User, agrees to be bound by the terms of this Agreement.
...
* Commercial Use is permitted subject to the following conditions, where if the User engages in commercial use, the Licensor reserves the right, at its sole discretion and without prior notice, to:
  ...
  * Release any or all User's Interacting assets under Apache 2.0 license either publicly, privately to Licensor, to designated third parties or a combination of any of them;
