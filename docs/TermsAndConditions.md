...
* If the User remove the attributions without the Licensor’s permission, User must pay monetary compensation to the Licensor based on a percentage of commercial value generated by them and losses to Licensor as a result from not displaying the attributions.
