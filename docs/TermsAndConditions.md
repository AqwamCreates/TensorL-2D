...
## License
These terms and conditions (“Agreement”) are a legal agreement between you (or company or organization) recognized as “User” and Aqwam Harish Aiman recognised as “Licensor” for the use of TensorL-2D Library (“Library”) within this terms and conditions. By using or possessing the Library, User, agrees to be bound by the terms of this Agreement.
...
The User acknowledges that if the Library is used or possesed by the User's Third Parties, the User's Third Partiess would also agree and comply to the terms and conditions of this Agreement.
